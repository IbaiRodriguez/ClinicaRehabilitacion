...
public class AdminFrame extends JFrame implements ListSelectionListener, ChangeListener {
	...
	static public final String ICONO_AÑADIR = "/iconos/añadir.png";
	static public final String ICONO_EDITAR = "/iconos/editar.png";
	static public final String ICONO_ELIMINAR = "/iconos/eliminar.png";
	static public final String ICONO_LOGOUT = "/iconos/logOut.png";
	static public final String STRING_AÑADIR_USUARIO = "Añadir un usuario";
	static public final String STRING_EDITAR_USUARIO = "Editar un usuario";
	static public final String STRING_ELIMINAR_USUARIO ="Eliminar un usuario";
	static public final String STRING_CERRAR_SESION = "Cerrar la sesión actual";
	static public final String ICONO_FISIO = "/iconos/fisio.png";
	static public final String ICONO_PACIENTE = "/iconos/paciente.png";
	static public final String ICONO_ADMIN = "/iconos/admin.png";
	static public final String STRING_AÑADIR = "Añadir";
	static public final String STRING_EDITAR = "Editar";
	static public final String STRING_ELIMINAR = "Eliminar";
	static public final String STRING_LOG_OUT = "Log out";
	static public final String STRING_SALIR = "Salir";
	...
	private void crearAcciones() {
		accAñadir = new MiAction(STRING_AÑADIR, new ImageIcon(this.getClass().getResource(ICONO_AÑADIR)), STRING_AÑADIR_USUARIO, KeyEvent.VK_A);
	...
	private Component crearPanelListasUsuarios() {
		...
		pestañas.setPreferredSize(new Dimension(349,0));
		
		this.inicializarModelosListasYRenderer();
		
		pestañas.addTab("Fisioterapeutas", new ImageIcon(this.getClass().getResource(ICONO_FISIO)),
						crearScrollUsuario(modeloFisios, listaFisios, cellRendererUsuario));
        
		pestañas.addTab("Pacientes", new ImageIcon(this.getClass().getResource(ICONO_PACIENTE)),
						crearScrollUsuario(modeloPaciente, listaPacientes, cellRendererUsuario));
        
		pestañas.addTab("Administradores", new ImageIcon(this.getClass().getResource(ICONO_ADMIN)),
