...
public class FisioFrame extends JFrame implements ListSelectionListener {
	...
	private void crearAcciones() {
		accAñadir = new MiAction("Añadir", new ImageIcon(this.getClass().getResource(AdminFrame.ICONO_AÑADIR)), "Añadir un paciente", KeyEvent.VK_A);
		accEditar = new MiAction("Editar", new ImageIcon(this.getClass().getResource(AdminFrame.ICONO_EDITAR)), "Editar un paciente", KeyEvent.VK_M);
		accEliminar = new MiAction("Eliminar", new ImageIcon(this.getClass().getResource(AdminFrame.ICONO_ELIMINAR)), "Eliminar un paciente", KeyEvent.VK_E);
		accLogOut = new MiAction("Log out", new ImageIcon(this.getClass().getResource(AdminFrame.ICONO_LOGOUT)), "Cerrar la sesión actual", KeyEvent.VK_O);
	}
	...
	private void modifica(){
		...
		if(pacienteNuevo != null){
			...
			modeloTabla.insertarListaEjercicios(e);
			this.repaint();
		}
	}
	...
	static public void crearTabla(JScrollPane scrollPaneTabla, Paciente paciente,ModeloTablaEjercicio modeloTablaExterno) {
		...
		modeloTabla.insertarListaEjercicios(paciente.getEjercicios());
	}
	...
	public void valueChanged(ListSelectionEvent evento) {
		if(!evento.getValueIsAdjusting()){
			...
			if(listaPacientes.getSelectedValue() != null){
				modeloTabla = new ModeloTablaEjercicio(new ModeloColumnasTablaEjercicios(), (Paciente)listaPacientes.getSelectedValue());
