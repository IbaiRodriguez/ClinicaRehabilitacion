...
public class PacienteFrame extends JFrame implements ListSelectionListener, Observer {
	...
	private final int EJERCICIO_DEDO_ANULAR = 3;
	private final int EJERCICIO_DEDO_MEDIO = 4;
	...
	private void crearAcciones() {
		...
		accPararEjercicio = new MiAction("Parar ejercicio", new ImageIcon("iconos/pararEjercicio.png"),
				"Parar ejercicio en marcha", KeyEvent.VK_P);
	...
	private class MiAction extends AbstractAction {
		...
		public void actionPerformed(ActionEvent e) {
			...
			case "Hacer ejercicio":
				PacienteFrame.this.accionEjercicio(Ejercicio.INACABADO);
				break;
	...
	public void update(Observable arg0, Object arg1) {
		...
		if (iniciarEjercicio && gestor.getHand() != null && gestor.getHand().isValid()) {
			...
			case EJERCICIO_DEDO_INDICE:
				...
				mostrarResultado(resultado, "Tocando", "Acerca solo dos dedos, depara los demas", "Separados");
				break;
	...
	private boolean mostrarResultado(RESULTADO resultado, String bien, String casi, String mal) {
		...
		if(terminado)
			accionEjercicio(Ejercicio.BIEN);
		return terminado;
	}

	
	public void accionEjercicio(int resultado) {
		if (iniciarEjercicio == false) {
			...
			progresoEjercicio.setValue(((Ejercicio) listaEjercicios.getSelectedValue()).getValorResultado(Ejercicio.BIEN));
	...
	public static void main(String[] args) {
		...
		PacienteFrame frame = new PacienteFrame((Paciente) GestorSockets.cargarUsuario("user1"));
