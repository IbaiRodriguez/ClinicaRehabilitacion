...
public class PacienteFrame extends JFrame implements ListSelectionListener, Observer {
	...
	private void crearAcciones() {
		...
		accHacerEjercicio = new MiAction("Hacer ejercicio", new ImageIcon(this.getClass().getResource(ICONO_EJERCICIO_EMPEZAR)),
				"Realizar ejercicio selecionado", KeyEvent.VK_H);
		accPararEjercicio = new MiAction("Parar ejercicio", new ImageIcon(this.getClass().getResource(ICONO_EJERCICIO_PARAR)),
				"Parar ejercicio en marcha", KeyEvent.VK_P);
		accLogOut = new MiAction("Log out", new ImageIcon(this.getClass().getResource(AdminFrame.ICONO_LOGOUT)), "Cerrar la sesión actual",
				KeyEvent.VK_O);
	}
	...
	public void valueChanged(ListSelectionEvent e) {
		...
		if (!e.getValueIsAdjusting()) {
			...
			ImageIcon icono = new ImageIcon(this.getClass().getResource(listaEjercicios.getSelectedValue().getDirectorioGIF()));
